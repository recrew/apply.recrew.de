                ...
                <SidebarWrapper>
                    <SidebarGroup>
                        ...
                        <SidebarDropdownWrapper label="Functional">
                            <SidebarDropdownItem
                                href="#functional"
                                on:click={(ev) => hookComponent("Structure")}
                                label="Structure"
                            />
                            <SidebarDropdownItem
                                href="#functional"
                                on:click={(ev) =>
                                    hookComponent("Internationalization")}
                                label="i18n / Internationalization"
                            />
                            <SidebarDropdownItem
                                href="#functional"
                                on:click={(ev) => hookComponent("Components")}
                                label="Components"
                            />
                            <SidebarDropdownItem
                                href="#functional"
                                on:click={(ev) => hookComponent("Api")}
                                label="API"
                            />
                            <SidebarDropdownItem
                                href="#functional"
                                on:click={(ev) => hookComponent("Stores")}
                                label="Stores"
                            />
                            <SidebarDropdownItem
                                href="#functional"
                                on:click={(ev) => hookComponent("Utils")}
                                label="Utils"
                            />
                        </SidebarDropdownWrapper>
                    </SidebarGroup>
        ...
        <section class="flex-1 xl:max-w-screen-lg mr-5 3xl:mr-12">
            <Card class="min-w-full">
                <article class="format lg:format-lg dark:format-invert">
                    ...
                    <p class="lead">
                        This template is meant to jump start svelte kit app
                        development with customization in mind
                    </p>
                    <p>
                        The package includes a complete setup of
                        svelte-flowbite, flowbite-icons, functional utilities,
