...
import { c as create_ssr_component, a as spread, b as escape_object, e as escape_attribute_value, d as add_attribute, v as validate_component } from "../../../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="my-8 w-4/5 mx-auto">${``} ${`${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})} <span class="dark:text-white text-lg pl-3" data-svelte-h="svelte-1ta8xq1">Loading ...</span>`}</div>`;
  } while (!$$settled);
  $$unsubscribe_page();
  return $$rendered;
});
