...
import { c as create_ssr_component, h as getContext, a as spread, e as escape_attribute_value, b as escape_object, v as validate_component, f as escape, d as add_attribute } from "./ssr.js";
...
const UserCircleSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<svg${spread(
    ...
    {}
  )}><path fill="currentColor" d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.948 8.948 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"></path></svg> `;
});
export {
  Button as B,
  Input as I,
